 ...
 <div class="col-md-1"></div>
    ...
    <p>Alumnos con tarjeta Activos:
        <?php
          ...
          $query = $mysqli -> query ("SELECT p.rut, p.dig_ver, p.nombres, p.apell_pat, p.Apell_mat, p.correo, p.direccion, p.telefono, al.id_tarjeta,p.password,al.estado FROM persona p JOIN alumno al ON p.rut=al.rut WHERE al.estado='1' AND p.rut= ");
